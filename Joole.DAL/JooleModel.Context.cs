...
namespace Joole.DAL
{
    ...
    public partial class JooleMarketPlaceEntities : DbContext
    {
        public JooleMarketPlaceEntities()
            : base("name=JooleMarketPlaceEntities")
        {
        }
        ...
        public virtual DbSet<tblDocuemnt> tblDocuemnts { get; set; }
